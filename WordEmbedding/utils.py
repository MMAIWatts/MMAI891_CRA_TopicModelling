...
# def data_master():
#     cols = ['Submitted date','What was the main purpose of your visit today? Please choose one option only. The list represents broad categories, and you may be asked to further specify the main reason why you visited today.','Approximately how often do you visit My Account?',
